...
`;m.li`
  ...
  border-radius: 8px;
  background: #f5f5f5;
`;de(),`${pe}`,de(),`${pe}`,de(),`${pe}`,de(),`${pe}`,de(),`${pe}`,de(),`${pe}`;const Fo=()=>(d.useEffect(()=>{window.scrollTo(0,0)},[]),n.jsxs("main",{children:[n.jsx(Ao,{}),n.jsx(wn,{}),n.jsx(Ro,{}),n.jsx(Mn,{}),n.jsx(oo,{}),n.jsx(Ut,{})]}));export{Fo as default};
